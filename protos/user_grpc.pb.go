...
const (
	UserManagement_CreateNewUser_FullMethodName = "/protos.UserManagement/CreateNewUser"
)
...
func (c *userManagementClient) CreateNewUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
func (UnimplementedUserManagementServer) CreateNewUser(context.Context, *UserRequest) (*UserResponse, error) {
...
func _UserManagement_CreateNewUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserManagementServer).CreateNewUser(ctx, req.(*UserRequest))
	}
